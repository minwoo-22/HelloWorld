...
import com.helloworld.project.domain.OAuthAttributes;
import com.helloworld.project.domain.SessionUser;
import com.helloworld.project.domain.User;
...
// 로그인 이후 가져온 사용자의 정보(email, name, picture 등) 들을 기반으로 가입 및 정보수정,  세션 저장 등의 기능을 지원한다.
// 사용자의 이름이나 프로필사진이 변경되면 User 엔티티에도 반영된다.
@Service
